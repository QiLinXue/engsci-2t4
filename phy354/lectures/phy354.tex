...
The term in the square brackets depends on only the geometry of the object, and is known as the \emf{moment of inertia} $I_{ij},$ which is a second-rank tensor. Therefore, the kinetic energy is:
\begin{equation}
