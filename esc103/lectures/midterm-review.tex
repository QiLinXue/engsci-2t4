...
\begin{idea}
    ...
    \begin{equation}
        |\vec{u}| = |\text{proj}_{\vec{v}}\vec{w}| = \frac{\vec{w}\cdot\vec{v}}{\lVert \vec{v}\rVert}
        \label{eq:}
    \end{equation}
\end{idea}
...
\begin{equation}
    ...
    \label{eq:}
\end{equation}
TODO: Will revisit this part with more plane related things (e.g. projections onto a plane, distance from line to plane, alternate representations of planes.)
